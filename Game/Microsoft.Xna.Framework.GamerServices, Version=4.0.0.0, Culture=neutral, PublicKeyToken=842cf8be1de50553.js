...
(function Gamer$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:true , Public:true }, "EndGetPartnerToken", 
      new JSIL.MethodSignature($.String, [$asm09.TypeRef("System.IAsyncResult")], [])
    );

    $.ExternalMethod({Static:false, Public:true }, "EndGetProfile", 
      new JSIL.MethodSignature($asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerProfile"), [$asm09.TypeRef("System.IAsyncResult")], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:false}, "ValidateGamerList", 
      new JSIL.MethodSignature($.Int32, [
          $asm09.TypeRef("System.Collections.Generic.IEnumerable`1", [$.Type]), $.Int32, 
          $.Int32, $.String
        ], [])
    );
...
(function InternalIndexComparer$b1$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ImplementInterfaces(
      /* 0 */ $asm09.TypeRef("System.Collections.Generic.IComparer`1", [new JSIL.GenericParameter("T", "Microsoft.Xna.Framework.GamerServices.InternalIndexComparer`1")])
    );
...
(function GamerCollection$b1$Members () {
  var $, $thisType;
  JSIL.MakeType({
      BaseType: $asm09.TypeRef("System.Collections.ObjectModel.ReadOnlyCollection`1", [new JSIL.GenericParameter("T", "Microsoft.Xna.Framework.GamerServices.GamerCollection`1")]), 
    ...
    $.ExternalMethod({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.IEnumerable$lMicrosoft.Xna.Framework.GamerServices.Gamer$g.GetEnumerator", 
      new JSIL.MethodSignature($asm09.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer")]), [], [])
    )
      .Overrides(2, "GetEnumerator");

    $.Field({Static:false, Public:false}, "wrappedList", $asm09.TypeRef("System.Collections.Generic.List`1", [$.GenericParameter("T")])); 
    ...
    $.ImplementInterfaces(
      /* 6 */ $asm09.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer")]), 
      /* 7 */ $asm09.TypeRef("System.Collections.IEnumerable")
    );
...
(function GamerCollectionEnumerator$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:false}, ".ctor", 
      new JSIL.MethodSignature(null, [$asm09.TypeRef("System.Collections.Generic.List`1/Enumerator", [new JSIL.GenericParameter("T", "Microsoft.Xna.Framework.GamerServices.GamerCollection`1/GamerCollectionEnumerator")])], [])
    );
    ...
    $.Field({Static:false, Public:false}, "internalEnumerator", $asm09.TypeRef("System.Collections.Generic.List`1/Enumerator", [$.GenericParameter("T")])); 
    ...
    $.ImplementInterfaces(
      /* 0 */ $asm09.TypeRef("System.Collections.Generic.IEnumerator`1", [new JSIL.GenericParameter("T", "Microsoft.Xna.Framework.GamerServices.GamerCollection`1/GamerCollectionEnumerator")]), 
...
(function GetEnumerator$gd__0$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ImplementInterfaces(
      /* 0 */ $asm09.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer")]), 
...
(function UserPacketBuffer$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, "StealSpaceFromEndOfBuffer", 
      new JSIL.MethodSignature($asm09.TypeRef("System.IntPtr"), [$.Int32], [])
    );
...
(function AchievementCollection$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:false}, ".ctor", 
      new JSIL.MethodSignature(null, [$asm09.TypeRef("System.Collections.Generic.List`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")])], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:true , Virtual:true }, "GetEnumerator", 
      new JSIL.MethodSignature($asm09.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")]), [], [])
    );
    ...
    $.Field({Static:false, Public:false}, "achievements", $asm09.TypeRef("System.Collections.Generic.List`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")])); 
    $.Field({Static:false, Public:false}, "achievementDictionary", $asm09.TypeRef("System.Collections.Generic.Dictionary`2", [$.String, $asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")])); 
    $.Field({Static:false, Public:false}, "isDisposed", $.Boolean); 
    $.Property({Static:false, Public:true }, "IsDisposed", $.Boolean);
    ...
    $.ImplementInterfaces(
      /* 0 */ $asm09.TypeRef("System.Collections.Generic.IList`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")]), 
      /* 1 */ $asm09.TypeRef("System.Collections.Generic.ICollection`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")]), 
      /* 2 */ $asm09.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")]), 
...
(function PropertyDictionary$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, "SetValue", 
      new JSIL.MethodSignature(null, [$.String, $asm09.TypeRef("System.TimeSpan")], [])
    );
    ...
    $.ImplementInterfaces(
      /* 0 */ $asm09.TypeRef("System.Collections.Generic.IDictionary`2", [$.String, $.Object]), 
      /* 1 */ $asm09.TypeRef("System.Collections.Generic.ICollection`1", [$asm09.TypeRef("System.Collections.Generic.KeyValuePair`2", [$.String, $.Object])]), 
      /* 2 */ $asm09.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm09.TypeRef("System.Collections.Generic.KeyValuePair`2", [$.String, $.Object])]), 
      /* 3 */ $asm09.TypeRef("System.Collections.IEnumerable")
    );
...
(function LeaderboardReader$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:true , Public:true }, "BeginRead", 
      new JSIL.MethodSignature($asm09.TypeRef("System.IAsyncResult"), [
          $asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardIdentity"), $asm09.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer")]), 
    ...
    $.ExternalMethod({Static:false, Public:true }, "get_Entries", 
      new JSIL.MethodSignature($asm09.TypeRef("System.Collections.ObjectModel.ReadOnlyCollection`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardEntry")]), [], [])
    );
    ...
    $.Property({Static:false, Public:true }, "Entries", $asm09.TypeRef("System.Collections.ObjectModel.ReadOnlyCollection`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardEntry")]));
...
(function Guide$Members () {
  ...
  JSIL.MakeStaticClass("Microsoft.Xna.Framework.GamerServices.Guide", true, [], function ($interfaceBuilder) {
    ...
    $.ExternalMethod({Static:true , Public:true }, "BeginShowMessageBox", 
      new JSIL.MethodSignature($asm09.TypeRef("System.IAsyncResult"), [
          $asm01.TypeRef("Microsoft.Xna.Framework.PlayerIndex"), $.String, 
          $.String, $asm09.TypeRef("System.Collections.Generic.IEnumerable`1", [$.String]), 
    ...
    $.ExternalMethod({Static:true , Public:true }, "BeginShowMessageBox", 
      new JSIL.MethodSignature($asm09.TypeRef("System.IAsyncResult"), [
          $.String, $.String, 
          $asm09.TypeRef("System.Collections.Generic.IEnumerable`1", [$.String]), $.Int32, 
          $asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.MessageBoxIcon"), $asm09.TypeRef("System.AsyncCallback"), 
          $.Object
        ], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:true }, "EndShowMessageBox", 
      new JSIL.MethodSignature($asm09.TypeRef("System.Nullable`1", [$.Int32]), [$asm09.TypeRef("System.IAsyncResult")], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:true }, "ShowComposeMessage", 
      new JSIL.MethodSignature(null, [
          $asm01.TypeRef("Microsoft.Xna.Framework.PlayerIndex"), $.String, 
          $asm09.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer")])
        ], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:true }, "ShowGameInvite", 
      new JSIL.MethodSignature(null, [$asm01.TypeRef("Microsoft.Xna.Framework.PlayerIndex"), $asm09.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer")])], [])
    );
...
(function ProxyProcess$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:true , Public:false}, "SafeCloseHandle", 
      new JSIL.MethodSignature(null, [$jsilcore.TypeRef("JSIL.Reference", [$asm09.TypeRef("System.IntPtr")])], [])
    );
    ...
    $.Field({Static:false, Public:false}, "triggerCallEvent", $asm09.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "callDoneEvent", $asm09.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "proxyProcessWantsToTalk", $asm09.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "sharedAsyncDataSafeToWrite", $asm09.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "aSyncHResultPtr", $asm09.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "asyncManagedCallArgument", $asm09.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "aSyncManagedCallTypePtr", $asm09.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "parentExitEvent", $asm09.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "serverProcess", $asm0B.TypeRef("System.Diagnostics.Process")); 
    $.Field({Static:false, Public:false}, "isDisposed", $.Boolean); 
    $.Field({Static:true , Public:false}, "virtualTitleId", $asm09.TypeRef("System.Nullable`1", [$asm09.TypeRef("System.Guid")])); 
    function ProxyProcess__cctor () {
      $thisType.virtualTitleId = new ($asm09.System.Nullable$b1.Of($asm09.System.Guid)) ();
    };
    ...
    $.Property({Static:false, Public:true , Virtual:true }, "ProxyProcessWantsToTalk", $asm09.TypeRef("System.IntPtr"));

    $.Property({Static:false, Public:true , Virtual:true }, "SharedAsyncDataSafeToWrite", $asm09.TypeRef("System.IntPtr"));
    ...
    $.Property({Static:true , Public:false}, "VirtualTitleId", $asm09.TypeRef("System.Guid"));
...
(function SharedMemoryRegion$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false}, "fileHandle", $asm09.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "mappedPointer", $asm09.TypeRef("System.IntPtr")); 
    $.Property({Static:false, Public:true }, "Size", $.Int32);

    $.Property({Static:false, Public:true }, "FileHandle", $asm09.TypeRef("System.IntPtr"));

    $.Property({Static:false, Public:true }, "MappedPointer", $asm09.TypeRef("System.IntPtr"));
...
(function FriendCollection$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ImplementInterfaces(
      /* 8 */ $asm09.TypeRef("System.IDisposable")
    );
...
(function GameDefaults$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, "get_PrimaryColor", 
      new JSIL.MethodSignature($asm09.TypeRef("System.Nullable`1", [$asm01.TypeRef("Microsoft.Xna.Framework.Color")]), [], [])
    );
    ...
    $.Field({Static:false, Public:false}, "primaryColor", $asm09.TypeRef("System.Nullable`1", [$asm01.TypeRef("Microsoft.Xna.Framework.Color")])); 
    $.Field({Static:false, Public:false}, "secondaryColor", $asm09.TypeRef("System.Nullable`1", [$asm01.TypeRef("Microsoft.Xna.Framework.Color")])); 
    ...
    $.Property({Static:false, Public:true }, "PrimaryColor", $asm09.TypeRef("System.Nullable`1", [$asm01.TypeRef("Microsoft.Xna.Framework.Color")]));

    $.Property({Static:false, Public:true }, "SecondaryColor", $asm09.TypeRef("System.Nullable`1", [$asm01.TypeRef("Microsoft.Xna.Framework.Color")]));
...
(function GamerProfile$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, "get_Region", 
      new JSIL.MethodSignature($asm09.TypeRef("System.Globalization.RegionInfo"), [], [])
    );
    ...
    $.Field({Static:false, Public:false}, "region", $asm09.TypeRef("System.Globalization.RegionInfo")); 
    ...
    $.Property({Static:false, Public:true }, "Region", $asm09.TypeRef("System.Globalization.RegionInfo"));
...
(function GamerServicesDispatcher$Members () {
  ...
  JSIL.MakeStaticClass("Microsoft.Xna.Framework.GamerServices.GamerServicesDispatcher", true, [], function ($interfaceBuilder) {
    ...
    $.Field({Static:true , Public:false}, "serviceProvider", $asm09.TypeRef("System.IServiceProvider")); 
    ...
    $.Field({Static:true , Public:false}, "changedPlayerIndices", $jsilcore.TypeRef("System.Array", [$.Int32]), function ($pi) {
        return JSIL.Array.New($asm09.System.Int32, 4);
      }); 
    ...
    $.Field({Static:true , Public:false}, "InstallingTitleUpdate", $asm09.TypeRef("System.EventHandler`1", [$asm09.TypeRef("System.EventArgs")])); 
    $.Field({Static:true , Public:false}, "guideMessageHooker", $asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.GuideMessageHooker")); 
    $.Field({Static:true , Public:false}, "pendingWindowHandle", $asm09.TypeRef("System.IntPtr")); 
...
(function SignedInGamer$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:true , Public:false}, "add_signedIn", 
      new JSIL.MethodSignature(null, [$asm09.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedInEventArgs")])], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:true }, "add_SignedOut", 
      new JSIL.MethodSignature(null, [$asm09.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedOutEventArgs")])], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:true }, "EndGetAchievements", 
      new JSIL.MethodSignature($asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.AchievementCollection"), [$asm09.TypeRef("System.IAsyncResult")], [])
    );
    ...
    $.Field({Static:false, Public:false}, "partySize", $.Int32); 
    $.Field({Static:true , Public:false}, "signedIn", $asm09.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedInEventArgs")])); 
    $.Field({Static:true , Public:false}, "SignedOut", $asm09.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedOutEventArgs")])); 
...
(function Achievement$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Property({Static:false, Public:true }, "EarnedDateTime", $asm09.TypeRef("System.DateTime"));
...
(function GuideRendererProxySource$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize($asm09.System.IServiceProvider)) ();
  };
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false}, "GuideRendererProxySource$ServiceProvider$value", $asm09.TypeRef("System.IServiceProvider"))
      .Attribute($asm09.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute")); 
    $.Property({Static:false, Public:true , Virtual:true }, "ServiceProvider", $asm09.TypeRef("System.IServiceProvider"));
